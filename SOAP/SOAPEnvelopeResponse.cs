...
public static class SOAPEnvelopeResponse
{
    ...
    public static ObjectResult SOAPFault(SOAPVersion version, SOAP1_2FaultSubCodes faultcode, Uri? node = null, SOAPFaultDetail? detail = null, Uri? role = null)
    {
        if (version == SOAPVersion.v1_1)
        {
            SOAP1_1ResponseEnvelope env = new SOAP1_1ResponseEnvelope();
    ...
    public static ObjectResult SOAPFault(SOAP1_1ResponseEnvelope env, string faultstring, SOAPFaultDetail detail, PartyAtFault faultcode)
    {
    ...
    public static ObjectResult SOAPFault(SOAP1_2ResponseEnvelope env, Reason reason, SOAP1_2FaultCodes faultcode, Uri? node, Uri? role, SOAPFaultDetail detail)
    {
    ...
    public static ObjectResult SOAPFault(SOAP1_2ResponseEnvelope env, Reason reason, SOAP1_2FaultCodes faultcode, SOAPFaultDetail detail, Uri? node, Uri? role)
    {
        var fault = env.Body_Typed.CreateFault(faultcode, reason);
        fault.Node = node;
        fault.Role = role;
    ...
    public static ObjectResult SOAPFault(SOAP1_2ResponseEnvelope env, Reason reason, FaultCode faultcode, Uri? node, Uri? role, SOAPFaultDetail? detail)
    {
        var fault = env.Body_Typed.CreateFault(faultcode, reason);
        fault.Node = node;
        fault.Role = role;
    ...
    public static ObjectResult SOAPFault(SOAP1_2ResponseEnvelope env, SOAP1_2FaultSubCodes faultcode, Uri? node, Uri? role, SOAPFaultDetail? detail)
    {
