...
// e.g.
// {url}?test - will bind to paramete string? test with a value of empty string
...
// Empty string means the parameter 
// A string value means the parameter
class QueryStringNullOrEmptyModelBinder : IModelBinder
{
    public Task BindModelAsync(ModelBindingContext bindingContext)
    {
        ...
        else
        {
            ...
            {
                // Value is valid string, use this value
