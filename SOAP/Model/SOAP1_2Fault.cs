...
public partial class SOAP1_2Fault : SOAPFault
{
    ...
    public static Dictionary<SOAP1_2FaultSubCodes, string> SOAP1_2FaultSubCodesMessages = new()
    {
        ...
        {SOAP1_2FaultSubCodes.FailedAuthentication, "The security token could not be authenticated or authorizied"},
        {SOAP1_2FaultSubCodes.FailedCheck, "The signature or decryption was invalid"},
        {SOAP1_2FaultSubCodes.SecurityTokenUnavailable, "Referenced security token could not be retrived"},
    };
    /* An example
            // <env:Code>
    ...
    {
        public string Value { get; init; }  // The init accessor allows the property to be set only during object initialization
